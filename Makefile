...
PROJECT_REPO ?= github.com/accenture/$(PROJECT_NAME)
...
export TERRAFORM_NATIVE_PROVIDER_BINARY ?= terraform-provider-vsphere_v2.4.0_x5
...
xpkg.build.provider-vmware: do.build.images
