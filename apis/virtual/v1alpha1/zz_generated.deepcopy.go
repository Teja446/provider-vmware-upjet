...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MachineDiskObservation) DeepCopyInto(out *MachineDiskObservation) {
	*out = *in
	if in.Attach != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MachineDiskObservation.
func (in *MachineDiskObservation) DeepCopy() *MachineDiskObservation {
	if in == nil {
		return nil
	}
	out := new(MachineDiskObservation)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MachineDiskParameters) DeepCopyInto(out *MachineDiskParameters) {
	*out = *in
	if in.Attach != nil {
		in, out := &in.Attach, &out.Attach
		*out = new(bool)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MachineDiskParameters.
func (in *MachineDiskParameters) DeepCopy() *MachineDiskParameters {
	if in == nil {
		return nil
	}
	out := new(MachineDiskParameters)
	in.DeepCopyInto(out)
	return out
}
...
func (in *MachineObservation) DeepCopyInto(out *MachineObservation) {
	*out = *in
	...
	if in.Disk != nil {
		...
		*out = make([]MachineDiskObservation, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *MachineParameters) DeepCopyInto(out *MachineParameters) {
	*out = *in
	...
	if in.Disk != nil {
		in, out := &in.Disk, &out.Disk
		*out = make([]MachineDiskParameters, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
